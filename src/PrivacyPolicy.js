  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Rideit, the software program
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Rideit Services Pvt. Ltd., Flat no 602
            D-wing Partiosh Balewadi , Pune.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          <p>By email: contact@rideitservices.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="http://rideitservices.com"
              rel="external nofollow noopener"
            
            >
              http://rideitservices.com
            </a>
          </p>
        </li>
      </ul>
